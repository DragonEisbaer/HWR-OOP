...
public class Girokonto extends Konto {
	...
	/**
	 * erstellt ein neues Girokonto von Minnie Mouse mit 10 € Startguthaben
	 * und einem Dispo von 555 €
	 */
	public Girokonto()
	{
		this(new Kunde(), 10, 555);
	}
     ...
     *                 false, wenn nicht
     * @throws IllegalArgumentException wenn der Betrag negativ bzw. ungültig ist oder
	...
	public boolean abheben(double betrag) throws GesperrtException{
		...
		if(this.isGesperrt())
			throw new GesperrtException();
		if (betrag <= getKontostand() + this.dispo)
		{
